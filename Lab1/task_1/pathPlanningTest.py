...
#
# Load the demo scene 'pathPlanningServer.ttt' in V-REP 
...
if clientID!=-1:
    ...
    maxConfigsToSearch=2 # how many of the found goal states are tested with OMPL
    searchCountPerConfig=2 # how many times OMPL will run for a given goal state
    ...
    inInts=[robotHandle,collisionChecking,minConfigsForIkPath,minConfigsForPathPlanningPath,maxConfigsForDesiredPose,maxTrialsForConfigSearch,maxConfigsToSearch,searchCountPerConfig]
    ...
    if (res==0) and len(path)>0:
        ...
        inInts=[robotHandle,collisionChecking,minConfigsForPathPlanningPath,searchCountPerConfig]
